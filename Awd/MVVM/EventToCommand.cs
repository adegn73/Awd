...
namespace Awd.MVVM
{
    public class EventToCommand : TriggerAction<DependencyObject>
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the EventArgs passed to the
        /// event handler is marked as Handled if it is a RoutedEvent and thereby
        /// bubbling is prevented
        /// </summary>
        public bool MarkRoutedEventAsHandled
        {
            get;
            set;
        }
        ...
        protected override void Invoke(object parameter)
        {
            ...
            var routedEventArgs = parameter as RoutedEventArgs;
            if (routedEventArgs != null && MarkRoutedEventAsHandled)
            {
        ...
        private void EnableDisableElement()
        {
            ...
            var frameworkElement = element as FrameworkElement;
            if (this.MustToggleIsEnabledValue && command != null && frameworkElement != null)
            {
                frameworkElement.IsEnabled = command.CanExecute(this.CommandParameterValue);
            }
        }
        ...
        /// is attached.</returns>
        private DependencyObject GetAssociatedObject()
        {
