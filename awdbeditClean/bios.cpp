...
//
//	// compress this file
//	err = lzhCompress(fe->name, fe->nameLen, fe->data, fe->size, tempbuf, tempbufsize, &usedsize, fe->type);
//
...
//	lzhhdra = (lzhHeaderAfterFilename*)((lzhhdr->filename) + lzhhdr->filenameLen);
//
//	lzhCompress(fname, fnameLen, data, size, tempbuf, tempbufsize, &usedsize, lzhhdr->fileType);
//
...
//}
//
//void ExtractAll(char  fullpath[256])
//{
//	fileEntry* fe;
//	int t;
//
...
//		fe = &biosdata.fileTable[t];
//
//		ExtractSingle(fullpath, fe->name);
//	}
//}
//
//
//void Replace(char entry[256], char fileName[256])
//{
//	fileEntry* fe;
//	int t;
//
...
//	{
//		fe = &biosdata.fileTable[t];
//		if (strcmp(entry, fe->name) == 0)
//			curFileEntry = fe;
//		biosReplaceFile(fileName);
//	}
//}
//
//void List()
...
//	{
//		fe = &biosdata.fileTable[t];
//		std::cout << "Module " << fe->type << " File " << fe->name << " Compressed Size " << fe->compSize << " Original Size " << fe->size << std::endl;
//
//	}
//}
//
//void ExtractSingle(char  fullpath[256], char  moduleName[256])
//{
//	FILE* fp;
//	char fname[256];
//	fileEntry* fe;
//	int t;
//	// create a filename
//	sprintf(fname, "%s\\%s", fullpath, moduleName);
//
//	// write the data
//	for (t = 0; t < biosdata.fileCount; t++)
//	{
//		fe = &biosdata.fileTable[t];
//		if (strcmp(moduleName, fe->name) == 0)
//		{
//			fp = fopen(fname, "wb");
//			if (fp != NULL)
//			{
//				std::cout << "Extracting " << fe->name << "..." << std::endl;
//				fwrite(fe->data, 1, fe->size, fp);
//				fclose(fp);
//			}
//			else
